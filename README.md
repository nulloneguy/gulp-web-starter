...
* скачайте сборку с помощью [Git](https://git-scm.com/downloads): ```git clone https://github.com/nulloneguy/gulp-wweb-starter.git```
* перейдите в скачанную папку со сборкой: ```cd gulp-web-starter```
...
## :envelope: Контакты
По всем вопросам пишите в [Telegram](https://t.me/nulloneguy)

### Выгрузка на gh-pages
-   измените `<USERNAME>` и `<REPO>` в `deploy.sh`. 
    -   Должно получится что-то такое:  `git push -f https://github.com/username/web-starter.git main:gh-pages`
